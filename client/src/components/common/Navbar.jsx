    ...
    <header style={s.header}>
      <div style={s.inner}>
        ...
        <nav style={s.navLinks}>
          <Link to="/listings"            style={{ ...s.navLink, ...(isActive('/listings')            ? s.navLinkActive : {}) }}>Browse Tasks</Link>
          <Link to="/users/professionals" style={{ ...s.navLink, ...(isActive('/users/professionals') ? s.navLinkActive : {}) }}>Find Professionals</Link>
          {isBusiness && (
            <Link to="/tasks/new"         style={{ ...s.navLink, ...(isActive('/tasks/new')           ? s.navLinkActive : {}) }}>Post a Task</Link>
          )}
        </nav>
        ...
        <div style={s.right}>
          {!isAuthenticated ? (
            ...
            <>
              {/* Messages icon */}
              <Link to="/messages" style={s.iconBtn}>
                <span>💬</span>
                  ...
                  <div style={s.dropdown}>
                    ...
                    <div style={s.dropHeader}>
                      ...
                      <div>
                        ...
                        <div style={s.dropRole}>{isBusiness ? '🏢 Business' : '💼 Professional'}</div>
                      </div>
                    </div>
      ...
      {mobileOpen && (
        <div style={s.mobileMenu}>
          ...
          {isBusiness    && <Link to="/tasks/new"              style={s.mobileLink}>Post a Task</Link>}
          {isAuthenticated && (
            <>
...
const s = {
  ...
  iconBtn:     { position: 'relative', width: 38, height: 38, display: 'flex', alignItems: 'center', justifyContent: 'center', borderRadius: 8, fontSize: 18, textDecoration: 'none', color: '#374151' },
